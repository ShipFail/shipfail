          ...
          {/* <ul className="header-content-right">
              ...
              <Dropdown.Menu className="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                    ...
                    <Dropdown.Item as="li" className="dropdown-item" key={Math.random()}>
                      <div className="d-flex align-items-center">
                        ...
                        <div className="flex-grow-1 d-flex align-items-center justify-content-between">
                          <div>
                            <p className="mb-0 fw-medium"><Link href="#!" scroll={false}>{idx.heading}</Link></p>
                ...
                <div className={`p-3 empty-header-item1 border-top ${notifications.length === 0 ? 'd-none' : 'block'}`}>
                  <div className="text-center">
                    <Link href="#!" className="link-primary text-decoration-underline">View All</Link>
                  </div>
                </div>
            ...
            <Dropdown className="header-element dropdown">
              ...
              <Dropdown.Menu as="ul" className="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
                <Dropdown.Item as="li"><Link className="d-flex align-items-center" href="#!"><i className="bi bi-person fs-18 me-2 op-7"></i>Profile</Link></Dropdown.Item>
                <Dropdown.Item as="li"><Link className="d-flex align-items-center" href="#!"><i className="bi bi-envelope fs-16 me-2 op-7"></i>Inbox <span className="ms-auto badge bg-info">17</span></Link></Dropdown.Item>
                <Dropdown.Item as="li"><Link className="d-flex align-items-center" href="#!"><i className="bi bi-check-square fs-16 me-2 op-7"></i>Task Manager</Link></Dropdown.Item>
                <Dropdown.Item as="li"><Link className="d-flex align-items-center" href="#!"><i className="bi bi-gear fs-16 me-2 op-7"></i>Settings</Link></Dropdown.Item>
                <Dropdown.Item as="li"><Link className="d-flex align-items-center" href="#!"><i className="bi bi-headset fs-18 me-2 op-7"></i>Support</Link></Dropdown.Item>
                <Dropdown.Item as="li"><Link className="d-flex align-items-center" href="#!"><i className="bi bi-box-arrow-right fs-18 me-2 op-7"></i>Log Out</Link></Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
            <li className="header-element">
                ...
                <Tab.Content>
                  <Tab.Pane eventKey="side1" className="p-0" id="side1">
                    <div className="text-end m-3">
                      <Link href="#!" className="text-primary">Mail Settings</Link>
                    </div>
                    <div className="px-3 pt-0 pb-3 border-bottom border-block-end-dashed">
                      <div className="d-flex align-items-center justify-content-between gap-1 mb-3">
                        ...
                        <Link href="#!" className="btn btn-sm btn-primary-light btn-icon btn-icon"><i className="ri-chat-1-line"></i></Link>
                      </div>
                    ...
                    <div className="p-3 border-bottom border-block-end-dashed">
                      <div className="d-flex align-items-center justify-content-between gap-1 my-3">
                        ...
                        <Link href="#!" className="btn btn-sm btn-primary-light btn-icon btn-icon"><i className="ri-add-circle-line"></i></Link>
                      </div>
                    ...
                    <div className="p-3 text-center">
                      ...
                      <Link href="#!" className="btn btn-outline-primary btn-block">Mail Settings</Link>
                    </div>
                  </Tab.Pane>
                  <Tab.Pane eventKey="side2" className="p-0" id="side2">
                    ...
                    <div className="p-3">
                      <div className="text-center">
                        ...
                        <Link href="#!" className="btn btn-block btn-outline-primary">Go To Profile Settings</Link>
                      </div>
                    </div>
                  </Tab.Pane>
                </Tab.Content>
