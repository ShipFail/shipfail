            ...
            <div className="offcanvas offcanvas-end" tabIndex={-1} id="switcher-canvas" aria-labelledby="offcanvasRightLabel">
                ...
                <div className="offcanvas-body">
                            ...
                            <div className="d-flex justify-content-between canvas-footer flex-wrap">
                                <Link href="https://themeforest.net/user/spruko/portfolio" className="btn btn-primary m-1" target="_blank">Buy Now</Link>
                                <Link href="https://themeforest.net/user/spruko/portfolio" className="btn btn-secondary m-1" target="_blank">Our Portfolio</Link>
                                <Link href="#!" scroll={false} id="reset-all" className="btn btn-danger m-1"
